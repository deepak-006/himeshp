...
<div class="appHeader1 height">
  <div class="text-center"> 
    <div class="pageTitle"><i class="icon ion-md-download"></i> Welcome</div>
  </div>
...
<!-- App Header -->
<div class="appHeader">
  <div class="pageTitle"  > <h1 style="color:#ffb700; font-size: 26px; font-family: arial;">Mskwinn</h1></div>
</div>
