...
<div id="overlay"></div>
 ...
 ?>
             ...
             <label>Star <br><input type="radio" class="tabbtn" name="tab" value="parity" <?php if($role['tab']=='sapre'){echo"checked";} ?>></label>&nbsp;&nbsp;&nbsp;&nbsp;
             <label>Parity <br><input type="radio" class="tabbtn" name="tab" value="sapre" <?php if($role['tab']=='parity'){echo"checked";} ?>></label>&nbsp;&nbsp;&nbsp;&nbsp;
             <label>Sapre <br><input type="radio" class="tabbtn" name="tab" value="bcone" <?php if($role['tab']=='bcone'){echo"checked";} ?>></label>&nbsp;&nbsp;&nbsp;&nbsp;
             <label>Bcone <br><input type="radio" class="tabbtn" name="tab" value="emerd" <?php if($role['tab']=='emerd'){echo"checked";} ?>></label>
             <input type="hidden" name="tabtype" id="tabtype" value="<?php echo $role['tab'];?>">
              ...
              <div class="col-xs-3">
                <div class="main-input pull-right">
                    ...
                    <b>Alert: </b><label style="color: red;">Don't Touch This Button!</label>
                    <div class="mt-0">
          ...
          <input type="radio" class="switchbutton" name="switch" id="switchno" value="no" <?php if($role['switch']=='no'){echo"checked";} ?>> No </label>
             ...
             <center><b>Note: </b><label style="color: red;">Don't Close or Change Page After Raising Manual Result, wait For 2:45 Countdown Timer.</label> </center>
            <!-- /.box-header -->
            <div class="box-body">
