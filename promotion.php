...
<div class="appHeader1" style="box-shadow:none;background-color:#ffb700 !important">
  <div class="left"> <a href="#" onClick="goBack();" class="icon goBack"> <i class="icon ion-md-arrow-back"></i> </a>
    <div class="pageTitle">Refer And Earn</div>
  </div>
...
<p id="p1"><strong style="color:blue;"> https://MSKwinn.in/signup.php?code=<?php echo user($con,'owncode',$userid);?></strong></p>

<button onclick="copyToClipboard('#p1')" class="btn btn-sm"style="background-color: #ffb700;">Copy Link</button>
